...
def add_model_flags(parser):
  parser.add_argument(
      ...
      default="models/model_quant.tflite")
...
def classify_audio(audio_device_index, interpreter,
                   sample_rate_hz=44100,
                   threshold=-3481.649758212946, num_frames_hop=1):
  """Acquire audio, preprocess, and detect."""
  # Initialize recorder.
  ...
  with recorder:
    while not timed_out:
      ...
      score=interpreter.score_samples(spectrogram)

      if score<threshold:
         print("ANOMALY!!!!!!, loss:{}".format(score))
      else:
         print("normal, loss:{}".format(score))
